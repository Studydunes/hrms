        ...
        <footer id="content-footer" class="affix">
            <div class="row">
                <div class="col-md-6 copyright">
                    <span class="footer-legal">Soarlogic © 2016 All rights reserved. By <a
                                href="http://www.soarlogic.com/" target="_blank">Soarlogic</a></span>
                </div>
...
@stack('scripts')
{{-- Loader --}}
{{-- <div id="loader" style="top: 0;width: 100%;
    height: 100%;
    background: #00000047;
    position: absolute;
    bottom: 0;">
    <img id="loader_gif" src="{{ asset('img/loader.gif') }}">
</div> --}}
</body>
</html>