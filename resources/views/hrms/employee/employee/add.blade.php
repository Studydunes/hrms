                                ...
                                <section class="wizard-section">
                                    ...
                                    {{-- <div class="section">
                                        ...
                                        <label for="input002" class="field prepend-icon">
                                            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')
                                                <input type="number" name="emp_code" id="emp_code" class="gui-input"
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="field prepend-icon">
                                            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')
                                                <input type="date" {{-- id="datepicker1" --}} id="datepick1" class="gui-input fs13" name="dob"
                                                       value="@if($emps && $emps->employee->date_of_birth){{$emps->employee->date_of_birth}}@endif" required>
                                                <label class="field-icon">
                                                    <i class="  fa fa-calendar-o"></i>
                                                </label>
                                            @else
                                                <input type="date" {{-- id="datepicker1" --}} id="datepick1" class="gui-input fs13" name="dob" required >
                                                <label class="field-icon">
                                                    <i class="  fa fa-calendar-o"></i>
                                                </label>
                                            @endif
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="field prepend-icon">
                                            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')
                                                <input type="date" {{-- id="datepicker4" --}} id="datepick4" class="gui-input fs13" name="doj"
                                                       value="@if($emps && $emps->employee->date_of_joining){{$emps->employee->date_of_joining}}@endif" required />
                                                <label class="field-icon">
                                                    <i class="fa fa-calendar-o"></i>
                                                </label>
                                            @else
                                                <input type="date" {{-- id="datepicker4" --}} id="datepick4" class="gui-input fs13" name="doj" required  />
                                                <label class="field-icon">
                                                    <i class="fa fa-calendar-o"></i>
                                                </label>
                                            @endif
...
{{-- ================End Of Email========================== --}}
                                ...
                                <section class="wizard-section">
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="field prepend-icon">
                                            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')
                                                <input type="date" {{-- id="datepicker5" --}} id="datepick5" class="gui-input fs13" name="doc"
                                    ...
                                    <div class="section">
                                        <label for="input002"><h6 class="mb20 mt40"> Department </h6></label>
                                            <select class="select2-single form-control" name="department" id="department">
                                                ...
                                                @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')
                                                    @if($emps->employee->department == 'Human Resource')
                                ...
                                <section class="wizard-section">
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="field prepend-icon">
                                            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')
                                                <input type="date" {{-- id="datepicker6" --}} id="datepick6" class="gui-input fs13" name="dor"
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="field prepend-icon">
                                            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')
                                                <input type="text" {{-- id="datepicker7" --}} id="datepick7" class="gui-input fs13"
...
<script>
    function redirect() {
        ...
        location.href = "http://hr.soarlogic.com/dashboard";
    }
