            ...
            <ul class="nav sub-nav">
                <li>
                    <a href="{{url('/admin-user/create')}}">
                        <span class="glyphicon glyphicon-tags"></span>Add Users
                    </a>
                </li>
                <li>
                    <a href="{{url('/admin-user')}}">
                        <span class="glyphicon glyphicon-tags"></span>User Listing
                    </a>
                </li>
                <li>
                    <a href="{{route('upload-emp')}}">
                        <span class="glyphicon glyphicon-tags"></span> Upload
                    </a>
                </li> 
            </ul>
        </li>
