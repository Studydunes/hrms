...
//    Route::post('edit-project/{projectId}', 'ProjectController@saveProjectEdit');
    ...
    //===============================Payroll Routes====================================
    Route::get('payroll-groups', ['as' => 'pay-groups', 'uses' => 'PayrollController@paygroup_index']);
    Route::get('payroll-show', ['as' => 'pay-show', 'uses' => 'PayrollController@paygroup_show']);

    Route::get('payroll-employees', ['as' => 'employee-list', 'uses' =>'PayrollController@showEmployee' ]);

    Route::get('payroll-modify/{id}', ['as' =>'payroll-edit','uses'=>'PayrollController@edit_payroll']);

    Route::post('payroll-update', ['as' =>'payroll-update','uses'=>'PayrollController@update_payroll']);

    Route::post('emp-delete',['as'=>'delete-user','uses'=>'PayrollController@remove_employee']);
});
