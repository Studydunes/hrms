    ...
    $(document).ready(function () {
        ...
        form.children(".wizard").steps({
            ...
            onStepChanging: function (event, currentIndex, newIndex) {
                ...
                var mobNo = $('#mobile_phone').val();
                var emerNo = $('#emergency_number').val();
                ...
                if(mobNo != emerNo){
                   ...
                   $('#mob_no').html("Mobile and Emergency no cannot be same").css('display','block');
                }
            ...
            onFinished: function (event, currentIndex) {
                ...
                var datepicker1 = $('#datepick1').val();
                // var datepicker4 = $('#datepicker4').val();
                var datepicker4 = $('#datepick4').val();
...
document.addEventListener('DOMContentLoaded', function(){
    ...
    document.getElementById('datepick1').addEventListener('change', function(){
        valid_date('datepick1');
    });
    
    document.getElementById('datepick4').addEventListener('change',function(){
        valid_date('datepick4');
    });
    
    document.getElementById('datepick5').addEventListener('change',function(){
        valid_date('datepick5');
    });

    document.getElementById('datepick6').addEventListener('change',function(){
        valid_date('datepick6');
    });
});
